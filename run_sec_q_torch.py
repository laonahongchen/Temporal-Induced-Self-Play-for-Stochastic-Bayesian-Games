...
from env.sec_history import SecurityEnv
from q_learning_controller import NaiveController
...
def parse_args():
    ...
    parser.add_argument('--n-belief', type=int, default=20)
...
if __name__ == "__main__":
    ...
    for prior in priors:
        ...
        if train:
            controller = NaiveController(env, max_episodes, lr, gamma, test_every, args.seed)
            controller.train(num_round=100000)
