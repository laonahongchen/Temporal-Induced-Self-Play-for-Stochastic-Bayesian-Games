...
if __name__ == "__main__":
    ...
    if train:
        controller = NaiveController(env, max_episodes, lr, betas, gamma, clip_eps, n_steps, network_width, test_every, n_belief, args.batch_size, args.minibatch, k_epochs=1, seed=args.seed)
        # controller.train(round_each_belief=max_steps)

        # controller.test_env_input(args.exp_name)
        controller.sub_game_exploitability(exp_name=args.exp_name)
