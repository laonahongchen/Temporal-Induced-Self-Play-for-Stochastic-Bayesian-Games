...
if __name__ == "__main__":
    ...
    env = SecurityEnv(n_slots=2,n_types=2,n_rounds=n_steps, prior=prior,zero_sum=True,seed=args.seed)
    tot_res = []
    ...
    if train:
        controller = NaiveController(env, max_episodes, lr, betas, gamma, clip_eps, n_steps, network_width, test_every, n_belief, args.batch_size, args.minibatch, max_process=args.max_process, seed = args.seed)
        controller.train_main_process(round_each_belief=max_steps, subpros_name='run_sec_subp')
