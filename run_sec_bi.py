...
from bi_controller_torch import NaiveController
...
if __name__ == "__main__":
    ...
    for i_seed in seeds:
        ...
        for prior in priors:
            ...
            if train:
                controller = NaiveController(env, max_episodes, lr, betas, gamma, clip_eps, n_steps, network_width, test_every, n_belief, args.batch_size, args.minibatch, k_epochs=40, v_batch_size=40)
